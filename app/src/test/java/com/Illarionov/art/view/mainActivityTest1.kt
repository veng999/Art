...
import com.Illarionov.art.view.actions.SingleDateAndTimePickerAction
import com.Illarionov.art.view.testExtensions.onView1
...
class ArtNavigationTest {
    ...
    fun testAddTask() {
        ...
        onView1(R.id.datePicker)
            ...
            .perform(SingleDateAndTimePickerAction())
